...
#         self.assertTrue(TestLexer.checkLexeme("a1231a_","a1231a_,<EOF>",105))

#     def test_id_with_digits2(self):
#         self.assertTrue(TestLexer.checkLexeme("_a1231a","_a1231a,<EOF>",106))

#     def test_declare(self):
#         self.assertTrue(TestLexer.checkLexeme("int","int,<EOF>",107))
...
#             """, "123,abc,123,_abc,00123,_123abc,<EOF>", 122))
...
#                 r"""
#             123abc 123_abc 00123_123abc
#             """, "123,abc,123,_abc,00123,_123abc,<EOF>", 123))
